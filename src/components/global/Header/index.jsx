...
import CartDrawer from "@/components/general/cart/cart-drawer";
...
export default function Header() {
  ...
  // Listen for "open-cart" custom events dispatched by AddToCartButton
  useEffect(() => {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative flex h-9 w-9 items-center justify-center rounded-lg text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800 transition-colors"
            >
              ...
              {totalQuantity > 0 && (
                <motion.span
                  ...
                  className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-indigo-600 px-1 text-[9px] font-bold text-white"
                >
      ...
      {/* Cart Drawer — rendered at header level so it's outside all page stacking contexts */}
